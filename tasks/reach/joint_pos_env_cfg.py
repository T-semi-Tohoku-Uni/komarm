...
class KomarmReachEnvCfg(ReachEnvCfg):
    def __post_init__(self):
        ...
        # override rewards
        self.rewards.end_effector_position_tracking.params["asset_cfg"].body_names = ["hand_unit_v1_1"]
        self.rewards.end_effector_position_tracking_fine_grained.params["asset_cfg"].body_names = ["hand_unit_v1_1"]
        self.rewards.end_effector_orientation_tracking.params["asset_cfg"].body_names = ["hand_unit_v1_1"]
        ...
        self.commands.ee_pose.body_name = ["hand_unit_v1_1"]
